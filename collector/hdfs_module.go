...
var hdfs_query_variable_relationship = []relation{
	...
	{HDFS_DFS_CAPACITY_REMAINING, *hdfs_dfs_capacity_remaining},
	...
	{HDFS_BLOCK_MISSING, *hdfs_missing_blocks},
	{HDFS_BLOCK_UNDER_REPLICATED, *hdfs_under_replicated_blocks},
	{HDFS_CORRUPT_BLOCKS, *hdfs_corrupt_blocks},
	...
	{HDFS_NAMENODE_JVM_HEAP_USED_MB, *hdfs_namenode_jvm_heap_used_mb},
